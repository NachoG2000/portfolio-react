    ...
    <div className={`flex items-center justify-center cursor-pointer`}>
      {
        ...
        <div className='group relative'>
          ...
          <a href={props.url} target="_blank" className="absolute inset-0 bg-gray-800 bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"> </a>
        </div>
        :
